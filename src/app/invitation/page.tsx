...
const CURRENT_DATE = new Date(Date.UTC(2026, 6, 17)); // November is month 10 (0-indexed)
        ...
        <div className="min-h-screen bg-neutral-300 flex items-center justify-center p-8 font-cormorant relative">
            ...
            <div className="max-w-2xl text-center space-y-8">
                <p className="text-lg leading-relaxed">
                    ...
                    exclusive and intoxifying event at
                </p>
                ...
                <div className="mx-auto max-w-2xl px-4 sm:px-6 md:px-10 space-y-10 text-center sm:text-left">
                    ...
                    <div
                        ...
                        <p className="text-neutral-700 leading-relaxed text-center sm:text-left">
                            Cocktail attire is often spotted, but it is certainly not required. Dress like you are here for a good drink and an even better story. We've seen suits and denim at the same party — both ordered a second round.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p className="text-neutral-700 leading-relaxed text-center sm:text-left">
                            ...
                            The 7M mixologists will serve its second <em>Seven for Summer</em> menu, featuring
                            exquisite seasonal flavors and craft cocktails. An additional seven cocktails will return from previous menus. Two one-night-only cocktails will also be served.
                        </p>
                    </div>
                </div>
